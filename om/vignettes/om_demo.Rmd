...
When performing a deterministic projection, uncertainty is a consequence of the life-history parameter distributions only. By default, projections take place assuming a harvest rate equal the harvest rate at MNPL:
```{r}
